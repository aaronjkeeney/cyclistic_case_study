...
```
This shows the difference in the ways that members and casual riders use the bikeshare services. The most interesting feature to note is the gap in Ride Time for members. Additionally the longer tail on the Ride Time curve for casual users (cut shor here) shows that casual riders are more likely to take longer rides.
